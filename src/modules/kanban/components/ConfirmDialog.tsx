    ...
    {open && (
      ...
      >
        <motion.div
          ...
          role="alertdialog"
          aria-modal="true"
          className="w-full max-w-sm rounded-2xl border border-neutral-200/70 bg-white/95 p-5 shadow-2xl backdrop-blur-xl dark:border-neutral-800/70 dark:bg-neutral-950/95"
        >
